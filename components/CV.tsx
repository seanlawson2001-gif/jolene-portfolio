...
const education = [
  {
    ...
    details:
      "Skills: Video Editing, Graphic Design, Cinematography, Scriptwriting, Motion Graphics.",
  },
  {
    ...
    years: "2019 – 2020",
    details:
      "Head of Logistics — Sunway Model United Nations Conference 2019 (SUNMUN19). Peer-to-Peer (P2P) Counsellor. Cell Group Leader, Sunway Christian Fellowship.",
  },
];
...
const experience = [
  {
    ...
    details:
      "Customer service and customer satisfaction in a fast-paced retail environment. Petaling Jaya, Selangor — On-site.",
  },
  {
    ...
    years: "2024 – Present",
    details:
      "Creating original digital content across Instagram, TikTok, YouTube, and Twitch. Short films, advertisements, brand campaigns, and community-driven storytelling.",
  },
  {
    ...
    years: "2023 – Present",
    details:
      "Founded and operate a sustainable vintage thrift brand — sourcing, styling, photographing, and selling on Instagram and via Wix storefront.",
  },
];
...
const achievements = [
  {
    ...
    body: "Sunway Model United Nations Conference 2019 (SUNMUN19) - Managed logistics coordination for a large-scale conference, ensuring smooth execution of operations.",
    year: "2019",
  },
  {
    title: "Peer-to-Peer (P2P) Counsellor Volunteer",
    body: "Sunway College - Provided peer support and developed strong interpersonal and communication skills.",
    year: "2019",
  },
  {
    title: "Cell Group Leader of Sunway Christian Fellowship",
        ...
        <div className="grid md:grid-cols-12 gap-12 md:gap-16">
          ...
          <div className="md:col-span-7 space-y-14">
            ...
            <div className="reveal reveal-delay-1">
              <div className="flex items-center gap-2.5 mb-7">
                ...
                <h3 className="text-xs font-semibold tracking-widest uppercase text-charcoal">
                  Education
                </h3>
              </div>
                ...
                {education.map((item, i) => (
                  <div key={i} className="relative pl-5 border-l border-border">
                    ...
                    <div className="flex flex-wrap items-baseline justify-between gap-2 mb-1">
                      <h4 className="font-medium text-charcoal text-sm leading-snug">
                        {item.degree}
                      </h4>
          ...
          <div className="md:col-span-5 space-y-10">
            ...
            <div className="reveal reveal-delay-4 bg-cream dark:bg-[oklch(0.17_0.022_252)] rounded-2xl border border-border p-6">
              <h3 className="text-xs font-semibold tracking-widest uppercase text-charcoal mb-4">
                Languages
              </h3>
              <div className="space-y-3">
                {[
                  ...
                  >
                    ...
                    <span className="text-xs text-warm-gray bg-warm-white border border-border px-2 py-0.5 rounded-full">
                      {level}
                    </span>
                  </div>
                ))}
