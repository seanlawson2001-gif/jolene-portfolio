  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background: "radial-gradient(circle, #7A9A82 0%, transparent 70%)",
        }}
        aria-hidden="true"
      />
      <div
        className="hero-deco absolute top-1/3 left-0 w-32 h-px bg-terracotta opacity-30"
        aria-hidden="true"
      />
      ...
      <div className="relative max-w-6xl mx-auto px-6 pt-28 pb-20 md:pt-32 w-full">
        <div className="grid md:grid-cols-12 gap-8 items-center">
          ...
          <div className="md:col-span-7 lg:col-span-6">
            <p className="hero-subtitle section-label mb-5">
            ...
            <p className="hero-subtitle text-warm-gray text-base md:text-lg leading-relaxed max-w-md mb-10">
              Gen Z storytelling that sparks hypothetical questions with a side
              of humour, curiosity and creative juices. Based in Malaysia,
              building a community that thinks deeply, laughs freely, and lives
              kindly.
            </p>
            ...
            <div className="hero-cta flex items-center gap-5 mt-8">
              <span className="text-xs tracking-widest uppercase text-warm-gray font-medium opacity-60">
                Find me
              </span>
              <div className="flex gap-4 flex-wrap">
                {[
                  {
                    label: "Instagram",
                    href: "https://instagram.com/tjzoomer",
                  },
                  ...
                  {
                    label: "LinkedIn",
                    href: "https://www.linkedin.com/in/tangjolene/",
                  },
                  {
                    label: "Threads",
                    href: "https://www.threads.com/@tjzoomer",
                  },
                ].map(({ label, href }) => (
                  <a
                    key={label}
          ...
          <div className="hero-deco md:col-span-5 lg:col-span-6 flex justify-center md:justify-end">
            <div className="relative w-72 h-80 md:w-80 md:h-96 lg:w-96 lg:h-[480px]">
              ...
              <div className="absolute -top-3 -right-3 w-16 h-16 bg-terracotta rounded-full flex items-center justify-center shadow-md">
                <span className="font-display text-cream text-xl font-light">
                  2026
                </span>
              </div>
            </div>
      ...
      <div className="hero-scroll absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2">
        <span className="text-xs tracking-widest uppercase text-warm-gray opacity-50">
          Scroll
        </span>
        <ArrowDown
          size={14}
          className="text-warm-gray opacity-50 scroll-bounce"
        />
      </div>
    </section>
  );
